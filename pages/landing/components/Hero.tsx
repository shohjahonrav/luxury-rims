      ...
      <div className="absolute bg-linear-to-t from-black-primary via-transparent px-5 md:px-6.25 lg:px-10 flex justify-center items-end h-full to-transparent  w-full">
        <div className="max-w-[1830px] pb-15 w-full flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3.75">
            <span className="text-white leading-14 md:leading-[72.2px] font-medium text-[46px] md:text-[64px] lg:text-[68px] flex max-w-65 md:max-w-150">
              Premium Car Rims in Uzbekistan
            </span>
            <p className="text-[16px] md:text-[18px] text-navbar-text-primary">Experience unmatched comfort, style, and service — wherever the road takes you.</p>
